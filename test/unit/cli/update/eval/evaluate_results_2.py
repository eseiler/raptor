...
# plotting data
for method, colour in {"naive":COLOR_grey, "find_ibf_idx_traverse_by_similarity": COLOR_b, "find_ibf_idx_ibf_size": COLOR_g, "find_ibf_idx_traverse_by_fpr": COLOR_r}.items() :
