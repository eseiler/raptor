...
inline bool
is_fpr_exceeded_impl(raptor_index<index_structure::hibf> const & index, size_t const ibf_idx, size_t const bin_idx, bool const is_toplevel)
{
    auto & hibf = index.ibf();
    ...
    return new_fpr > /* 1.1 * */ target_fpr; // TODO lenience? merged only!
}
